...
myImage.addEventListener('load',function(){
    ...
    class Particle {
        ...
        draw(){
            //ctx.globalAlpha =0.2;//luminosidad
            ctx.beginPath();
